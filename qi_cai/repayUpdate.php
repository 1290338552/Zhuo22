...
$sqlS="select * from repay where id=$id "; //读取被修改的记录
$result=$db->db_select_oneRow($sqlS);
?>
<form action="repaySave.php?action=update&id=<?php  echo $result['id']; ?>" method="post" name="Form" enctype="multipart/form-data" >
    <div style="margin-left: auto;margin-right: auto;width: 400px; height: 650px; text-align: center;"> <!--页面居中-->
        ...
        <div style="width: 400px; height: auto;background-color: white;">
            ...
            <div style="width: 400px;text-align: left;margin-left: 50px;">
                ...
                <input  type="data" name="repaytime" value="<?php  echo $result['repaytime']; ?>" id="repaytime" placeholder="借用时间" required style="padding-left:30px;background:url(images/lock.jpg) no-repeat left  center;height: 40px;width: 260px; "><br/><br/>
