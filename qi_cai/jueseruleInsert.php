...
<form action="userJueseSave.php?action=insert" method="post" name="Form" enctype="multipart/form-data" >
    <div style="margin-left: auto;margin-right: auto;width: 400px; height: 650px; text-align: center;"> <!--页面居中-->
      <div style="width: 300px;text-align: left;"><span style="font-family:'Yu Gothic Light';font-size:40px;color: #748f62;text-align: left;width: 100px;">Juese TO Rule  IN </span></div>
      <div style="width: 400px; height: auto;background-color: white;">
          <div style="width: 400px;height: 40px; border-bottom: 1px solid #7c7b7d;padding-top: 10px;margin-bottom: 20px;">
              <div style="width: 110px;height:38px;color: #333333;margin-left: auto;margin-right: auto;text-align: center; border-bottom: 3px solid #434343;">角色模块添加</div>
          </div>
          <div style="width: 400px;text-align: left;margin-left: 50px;">
              ...
              <div id="ruleId999">
                  ...
                  foreach ($qx_rule as $key=>$item){
                      ?>
                      <input type="checkbox" name="ruleId[]" id="<?=$item['ruleId']?>" value="<?=$item['ruleId']?>"  ><?=$item['ruleName']?><br/>
                      <?php
                  }
                  ?>
              </div>
